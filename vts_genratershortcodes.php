...
add_shortcode('display_contact_page', array('MSstWPTigerShortcodes', 'vtst_display_page'));

add_shortcode('display_widget_area', array('MSstWPTigerShortcodes', 'vtst_display_widget'));

add_shortcode('Vts-tiger-New-form name=', array('MSstWPTigerShortcodes', 'vtst_genrate_code'));
