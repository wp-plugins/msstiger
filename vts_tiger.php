 ...
 * Description: WP VTiger Synchronization Plugin allows to fetch your VTiger crm leads and contacts form fields and let you generate forms for your wordpress website.
 * Version: 1.1.1
...
$plugin_url_vts_tiger = plugins_url('', __FILE__);
global $plugin_dir_vts_tiger;
$plugin_dir_vts_tiger = plugin_dir_path(__FILE__);

require_once "{$plugin_dir_vts_tiger}/VtsWp.php";
require_once "{$plugin_dir_vts_tiger}/vts_genratershortcodes.php";
require_once "{$plugin_dir_vts_tiger}/navMenu.php";
require_once "{$plugin_dir_vts_tiger}/VtsWPAdminPages.php";
require_once "{$plugin_dir_vts_tiger}/CaptureRegisteringUsers.php";
...
function vtst_Vtstigermenu() {
	global $plugin_url_vts_tiger;
	add_menu_page('VtsTiger Settings', 'Vts Tiger', 'manage_options', 'Vts_tiger', 'vtst_vtstiger_settings', "{$plugin_url_vts_tiger}/images/icon.png");
}

function vtst_LoadVtsTigerScript() {
	global $plugin_url_vts_tiger;
	wp_enqueue_script("Vts_tiger-script", "{$plugin_url_vts_tiger}/js/vts_script.js", array("jquery"));
	wp_enqueue_style("Vts_tiger-css", "{$plugin_url_vts_tiger}/css/VtsStyle.css");
}
...
function vtst_vtstiger_deactivate() {
	...
	delete_option('Vts_tiger-contact-form-attempts');
	delete_option('Vts_tiger-contact-widget-form-attempts');
}

function vtst_VtsTigertestAccess() {
	global $plugin_dir_vts_tiger;
	require_once "{$plugin_dir_vts_tiger}/test-access.php";
	die;
}
...
function vtst_VtstestVtigerAccess() {
	global $plugin_dir_vts_tiger;
	require_once "{$plugin_dir_vts_tiger}/test-vtiger-access.php";
	die;
}
