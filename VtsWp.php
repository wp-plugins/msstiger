...
class VTSWPVT {
	...
	public static function init() {
		...
		add_action('after_plugin_row_MSs-tiger/vts_tiger.php', array('VTSWPVT', 'plugin_row'));
		add_action('plugin_action_links_MSs-tiger/vts_tiger.php', array('VTSWPVT', 'plugin_settings_link'), 10, 2);
	}
	...
	public static function plugin_settings_link($links, $file) {
		...
		array_unshift($links, '<a href="' . admin_url("admin.php") . '?page=Vts_tiger">' . __('Settings', 'Vts_tiger') . '</a>');
